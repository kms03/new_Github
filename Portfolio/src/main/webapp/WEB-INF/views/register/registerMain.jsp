...
<div class="regi_div" style="float: left;">
<h1><a href="prev_month">&lt;</a>&nbsp;${date}&nbsp;<a href="next_month">&gt;</a></h1>
<form method="post" action="register_main" name="out_frm">
...
<table style="width: 60%; text-align: center; margin: auto; border: 1px solid #000;">
	...
	<tr>
		...
		<th style="text-align: center; width: 150px;">날짜</th>
		<th style="text-align: center; width: 95px;">금액</th>
		<th style="text-align: center; width: 120px;">수입내역</th>
		<th style="text-align: center; width: 100px;">수입분류</th>
		<th style="text-align: center; width: 200px;">메모</th>
	</tr>
...
<div style="text-align: center; padding-bottom: 10px;">
	...
	<input style="margin-right: 250px;" type="submit" id="searchBtn" onclick="search_keyword()" value="검색">
...
<div style="text-align: center; padding-bottom: 10px;">
	...
	<input style="margin-right: 250px;" type="submit" id="searchBtn" onclick="search_keyword()" value="검색">
	<button style="padding: 5px; margin-top: 5px; margin-right: 10px;" type="button" class="in_del_btn" onclick="outgoings_del()">삭제</button>
</div>
</form>
</div>
